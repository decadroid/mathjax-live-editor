...
function storageEvents(){
	if(isLocalStorage){
    	if(localStorage.name !== 'undefined'){$("#name").val(localStorage.name);$("#l-name").text(localStorage.name);$( "#n-sec" ).hide();$("#edit_details").show();}
    	if(localStorage.email !== 'undefined'){$("#email").val(localStorage.email);$( "#e-sec" ).hide();}
	}
}
